...
var Binary = require('bufferlist/lib/binary').Binary;
var Put = require('put');
...
function Parser (rfb, bufferList) {
    Binary(bufferList)
        ...
        .tap(function (vars) {
            ...
            Put().word8(vars.secNum).write(rfb);
        })
        .flush()
        .when('secNum', 2, function (vars) {
            this
                .getBuffer('challenge', 16)
                .tap(function (vars) {
        ...
        .forever(function (vars) {
            ...
            .tap(function (vars) {
                if (rfb.engine == 'vmware' || rfb.engine == 'tightvnc') rfb.dimensions(function (dims) {
                    rfb.subscribe({
                        x : 0, y : 0,
